  ...
  return (
    <div className="h-full flex flex-col items-center justify-center bg-white p-6">
      <div className="w-full max-w-md mb-4 overflow-hidden rounded-lg shadow-md">
        <img 
          src="https://images.unsplash.com/photo-1578884642129-8f47a4df2c8e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80" 
          alt="Gateway of India" 
          className="w-full h-auto"
        />
      </div>
      <h1 className="text-3xl font-bold font-sans text-center text-[#DC143C] mt-2">Maharashtra Tour Guide</h1>
      <p className="text-center text-gray-800 mb-8">Connect with local guides & explore Maharashtra</p>
